...
export default function SignupPage() {
    ...
    return (
        ...
        >
            <div className="mb-8">
                <Typography variant="h3" className="mb-2">Get started for free</Typography>
                <Typography variant="body" className="text-text-2">
                    Create your account and start generating UGC in minutes.
                </Typography>
            </div>
            ...
            <div className="relative mb-8">
                ...
                <div className="relative flex justify-center text-[11px] uppercase tracking-wider font-bold">
                    <span className="bg-bg-0 px-4 text-text-3">Or sign up with email</span>
                </div>
            </div>
            ...
            <form className="space-y-4 mb-8" onSubmit={handleSubmit}>
                <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        <label className="block text-[13px] font-medium text-text-1 mb-2">Last name</label>
                        <input
                            type="text"
                            placeholder="Doe"
                            className="w-full h-11 px-4 bg-bg-1 border border-border-0 rounded-lg text-[14px] focus:outline-none focus:border-accent/30 transition-colors"
                ...
                <div>
                    <label className="block text-[13px] font-medium text-text-1 mb-2">Work email</label>
                    <input
                        type="email"
                ...
                <div>
                    <label className="block text-[13px] font-medium text-text-1 mb-2">Password</label>
                    <input
                        type="password"
                ...
                <div className="mt-6 flex items-start gap-3">
                    ...
                    <label htmlFor="terms" className="text-[13px] text-text-2 leading-tight">
                        I agree to the <a href="#" className="underline text-text-1">Terms of Service</a> and <a href="#" className="underline text-text-1">Privacy Policy</a>.
                    </label>
                </div>
